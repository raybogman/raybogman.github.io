...
description: 'AI Content Orchestrator — a complete AI content pipeline inside WordPress: scan, SEO, write, image, link, publish. Free on WordPress.org. Supports Claude and OpenAI.'
...
Only if you choose to. Default workflow: AI generates → you review as draft → approve → publish. Scheduled content goes through a human-in-the-loop approval queue.

### Does it work with Yoast SEO?
Yes. When Yoast is installed, AI Content Orchestrator auto-populates the SEO title, meta description, and focus keyphrase fields. Works without Yoast too — metadata is always generated.

### Does it work with Thrive Architect?
Yes. Toggle "Thrive Architect" output format and AI-generated HTML is auto-converted to Thrive-compatible TCB2 markup. Optionally injects your saved Thrive Table of Contents and CTA templates.
...
25+ years in tech, ex-Adobe Head of Commerce Customer Engineering, AWS Certified AI Practitioner, Oxford AI Programme alumnus, and currently Head of Innovation at Alumio. This plugin is built from real experience with content at enterprise scale. [Learn more about Ray →](/about/)
